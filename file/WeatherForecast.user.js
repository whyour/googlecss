...
// @include        https://*
// @version        0.8.4.26
// @require        WeatherIconSets.user.js
// @updateURL     https://j.mozest.com/userscript/script/9.meta.js
// @screenshot    http://j.mozest.com/images/uploads/previews/000/00/00/1581cb84-0eb9-bd51-359a-900230591e92.jpg http://j.mozest.com/images/uploads/previews/000/00/00/thumb-1581cb84-0eb9-bd51-359a-900230591e92.jpg
// ==/UserScript==
 ...
 *
 * 2. autoDetect
 * 根据当前的IP地址自动检测天气信息。默认值：false。
 *
 * 3. day
 * 表示需要显示的天数，最多5天。默认值：5。
 *
 * 4. position
 ...
 *
 * 8. transparent
 * 设置天气显示界面透明度，范围0~1，数值越低表示透明度越高。默认值：0.9。
 *
 * 9. accessKey
 ...
 *
 * 10. clickToHide
 * 点击页面空白处隐藏天气预报视图，如果为false则关闭这功能。默认值为true。
 *
 * 11. shortcut
 * 是否开启快捷键支持，默认为true。
 *
...
var conf = {
    "user": {
        // City list
        citys: ['武汉','济南','石家庄','长春','哈尔滨','沈阳','呼和浩特','乌鲁木齐','兰州','银川','太原','西安','合肥','南京','杭州','福州','广州','南昌','海口','南宁','贵阳','长沙','郑州','成都','昆明','拉萨','西宁','天津','上海','重庆','北京','香港','澳门','深圳'],
